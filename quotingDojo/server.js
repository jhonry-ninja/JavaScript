...
// In this assignment, you are going to build a simple app that allows users to add 
// quotes to a database and display them on a separate page.
...
// When you create a new quote, if there are errors in the .save() method, 
// use flash messages to display the errors.
...
app.post("/quotes", function(req, res){
    ...
    quote.save(function(err){
        if(err){
            console.log(":: Something is messed up! ::", err);
            ...
            console.log(":: Success! You've added a quote! ::");
            res.redirect("/quotes");
        }
    })
})
...
app.listen(1955, function(){
    console.log("Running on port localhost:1955");
})